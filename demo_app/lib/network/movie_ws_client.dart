...
import 'package:demo_app/errors/movie_api_error.dart';
import 'package:http/http.dart';

abstract class MovieWsClient extends BaseClient {}

typedef _PendingRequest = Future<Response> Function();

class MovieWsClientImpl extends MovieWsClient {
  final Client _client;
  MovieWsClientImpl(this._client);
